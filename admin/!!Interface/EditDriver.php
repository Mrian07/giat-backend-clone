                                            ...
                                            <form role="form">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="1234" disabled>
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Nama Depan</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="Si Eneng">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Nama Belakang</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="Geulis pisan">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Tempat Lahir</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="Bandung">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Tanggal Lahir</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="1995-12-12">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx" value="087 123 845 351">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="sel1">
                                                            ...
                                                            <option value="Sidak-Massage">Sidak-Massage</option>
                                                            <option value="Sidak-Service">Sidak-Service</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="box-body">
