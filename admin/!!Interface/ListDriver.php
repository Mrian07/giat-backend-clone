...
<html>
    <head>
        ...
        <title>SIDAKANTAR - List Driver</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List ojek yang terdaftar</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Fauzan</td>
                                                <td>N 1235 FF</td>
                                                <td>085 456 159 357</td>
                                                <td>driver@sidakantar.net</td>
                                                <td><span class="label label-success">Aktif</span></td>
                                                <td><a href="DetailDriver.php"><button type="button" class="btn btn-default btn-sm">Lihat Detil Driver</button></a></td>
                                            </tr>
                                            <tr>
                                                <td>Kati</td>
                                                <td>N 1235 FF</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>085 456 159 357</td>
                                                <td>driver@sidakantar.net</td>
                                                <td><span class="label label-info">Non Aktif</span></td>
                                                <td><a href="DetailDriver.php"><button type="button" class="btn btn-default btn-sm">Lihat Detil Driver</button></a></td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
