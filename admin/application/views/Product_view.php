                                ...
                                <div class="box-body">
                                   ...
                                   if ($key->tipe_voucher == 'diskon persen') {
                                                ...
                                                ?>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/Voucher/hapusVoucher/<?php echo $key->id; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus voucher tersebut ?')"><span class="glyphicon glyphicon-remove"></span></button></a>
                                                    </td>
                                                </tr>
