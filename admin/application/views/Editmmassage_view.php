...
<html>
   ...
   <title>GoTaxi - Edit Status Go-Massage</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Detailed Massage Information</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="content-box">
                                ...
                                <!-- form start -->
                                <form action="<?php echo base_url(); ?>index.php/Listdriver/editStatusMmassage" method="POST" role="form" enctype="multipart/form-data">
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="idmmassage" type="hidden" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $driver[0]['id']; ?>">
