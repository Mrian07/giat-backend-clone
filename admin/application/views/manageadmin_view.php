...
<html>
    <head>
        ...
        <title>GOTAXI APP - Manage Admin</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Konfigurasi password admin</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <form role="form" action="<?php echo base_url(); ?>index.php/manageadmin/pengecekan" method="post">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Passworrd Baru</label>
                                                        <input name="passbaru" type="password" class="form-control" id="exampleInputEmail1" placeholder="" value="">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Re Enter New Password Baru</label>
