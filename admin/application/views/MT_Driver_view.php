...
<html>
    <head>
        ...
        <title>GoTaxi App - Add Wallet Driver</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title"> Manual Transaksi Ojek</div>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/Manualtransaction/penambahanDriver">
                                                            ...
                                                            <div class="modal-body">
                                                               Driver Name  &nbsp;= &nbsp;&nbsp;&nbsp;<b><?php echo "$d->nama_depan $d->nama_belakang"; ?>  </b>   
                                                                <br>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input class="btn btn-primary" type="submit" value="Add Wallet">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
