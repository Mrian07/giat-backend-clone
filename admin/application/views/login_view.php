...
<img src="/asset/css/login/taxi1.jpg" style="width:100%;height:100%;" />
<img src="/asset/css/login/taxi.jpg" style="width:100%;height:100%;" />
</div>
</div>
            ...
            <div class="col-md-4">
                ...
                <div class="box box-info" style="margin-top: 40%">
                    <div class="box-header with-border">
                        <h3 class="box-title">Admin Panel || Giat App</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
