...
<html>
    <head>
        ...
        <title>GoTaxi App - Restaurant Category</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Kategori Rumah Makan Terdaftar</div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form action="<?php echo base_url(); ?>index.php/Kategoriresto/insertKategori" method="POST" role="form" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="">Kategori :</label>
                                                <input name="kategori" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="">
                                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($kategoriresto as $key) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $key->kategori; ?></td>
                                                        <td><img src="<?php echo base_url() . "/fotokategoriresto/" . $key->foto; ?>" class="img-responsive img-thumbnail" alt=""></td>
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>index.php/Kategoriresto/editKategoriForm/<?php echo $key->id; ?>"><button type="button" class="btn btn-default btn-xs">Edit</button></a>
                                                            <!--<a href="#"><button type="button" class="btn btn-danger btn-xs" onclick="return confirm('Apakah anda yakin untuk menghapus kategori restoran tersebut ?')">Hapus</button></a>-->
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
