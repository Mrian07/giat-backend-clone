...
<html>
    <head>
        ...
        <title>GoTaxiApp - All Transaction</title>
				...
				<div class="user-top-profile">
					...
					<div class="clear">
						...
						<ul class="user-top-menu animated bounceInUp">
							...
							<li><a href="<?php echo base_url(); ?>">Pengaturan</a></li>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Transaksi Terakhir</div>
                        ...
                        <div class="col-md-12">
                            <div class="content-box">
                                <div class="box-header">
                                    <h3 class="box-title">Transaksi terakhir dari pelanggan</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <span class="label label-info">Mencari</span> = <b><?php echo $Mencari[0]['jumlah']; ?></b> &nbsp&nbsp
                                    <span class="label label-info">Sukses</span> = <b><?php echo $Berhasil[0]['jumlah']; ?></b> &nbsp&nbsp
                                    <span class="label label-info">Mulai</span> = <b><?php echo $Memulai[0]['jumlah']; ?></b> &nbsp&nbsp
                                    <span class="label label-success">Selesai</span> = <b><?php echo $Selesai[0]['jumlah']; ?></b> &nbsp&nbsp
                                    <span class="label label-danger">Dibatalkan</span> = <b><?php echo $Dibatalkan[0]['jumlah']; ?></b> &nbsp&nbsp
                                    <span class="label label-danger">Ditolak</span> = <b><?php echo $Ditolak[0]['jumlah']; ?></b> &nbsp&nbsp
