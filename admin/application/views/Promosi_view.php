...
<html>
    <head>
        ...
        <title>GoTaxi App -Promotion Home</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Set Banner Promosi </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form role="form" action="<?php echo base_url(); ?>index.php/Promotion/tambahPromosi" method="POST" enctype="multipart/form-data">
                                                <br><br><label>Upload Baru Gambar Promosi: </label>
                                                <input type="file" name="userfile"><br>

                                                <label>Tipe Promosi Fitur : </label><br>
