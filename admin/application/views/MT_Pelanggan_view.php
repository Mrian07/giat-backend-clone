...
<html>
    <head>
        ...
        <title>GoTaxi App - Add Money Customer</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Manual Transaksi Pelanggan</div>
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/Manualtransaction/penambahanPelanggan">
                                                            ...
                                                            <div class="modal-body">
                                                                Nama Pelanggan  &nbsp;= &nbsp;&nbsp;&nbsp;<b><?php echo "$d->nama_depan $d->nama_belakang"; ?>  </b>   
                                                                <br>
                                                                Current wallet &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;= &nbsp;&nbsp;&nbsp;<b><?php echo "$ $d->saldo"; ?>  </b>                                                                
                                                                <hr>
                                                                <div class="form-group">
                                                                    <label for="">Tambahan Nominal ($)</label>
