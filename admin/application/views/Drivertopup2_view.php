...
<html>
    <head>
        ...
        <title>GoTaxi-App - Driver Topup</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">List drivers that do the TopUp</div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <br>
                                            <h3class="box-title"><b>Details Topup</b></h3> <br>
                                        ...
                                        <div class="col-md-4">
                                            <a href="<?php echo "http://" . $_SERVER['HTTP_HOST'] . "/asset/berkas_topup/driver/" . $detailtopup[0]['bukti']; ?>">
                                                <img src="<?php echo "http://" . $_SERVER['HTTP_HOST'] . "/asset/berkas_topup/driver/" . $detailtopup[0]['bukti']; ?>" class="img-responsive img-thumbnail" alt="">
                                            </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <?php // var_dump($detailtopup)?>
                                            <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/drivertopup/validasiTopup/<?php echo $detailtopup[0]['nomor']; ?>/<?php echo $detailtopup[0]['id_user']; ?>" role="button" onclick="return confirm('Are you sure to verify the Topup ?')">Topup verification</a>
                                            <a href="<?php echo base_url(); ?>index.php/drivertopup/batalTopup/<?php echo $detailtopup[0]['nomor']; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to cancel the top up ?')"><span class="glyphicon glyphicon-remove"></span></button></a>
                                        </div>
