...
<html>
    <head>
     ...
     <title>GoTaxi - Massage Information Detail</title>
...
<a href="<?php echo base_url(); ?>index.php/listdriver/driverMotor"> Detail Go-Service information </a> </div>
                        ...
                        <div class="col-md-12">
                             <div class="content-box">
                                ...
                                <div class="box-header">
                                    <h3 class="box-title">Detail Go-Service information</h3>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><p class="text-left">: 
                                                        ...
                                                        <a  href="<?php echo base_url();?>index.php/Listdriver/editMmassageForm/<?php echo $driver[0]['id']; ?>" style="margin-top: -28px"class="btn btn-primary btn-xs pull-right" href="#" role="button">Edit Status Driver</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
