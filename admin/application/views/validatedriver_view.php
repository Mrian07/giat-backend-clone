...
<html>
    <head>
        ...
        <title>GOTAXI | Validate Driver <?php echo "$tittle";?></title>
...
<!-- limit body -->
 ...
 <div class="wrapper ">
	...
	<a href="<?php echo base_url(); ?>index.php/Listpelanggan">validate registrants <?php echo "$tittle";?></a> </div>
                                  ...
                                  <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $no++ ?></p></td>
                                                    ...
                                                    <td><a href="<?php echo base_url() ?>index.php/Validatedriver/detilPelamarDriver/<?php echo "$d->nomor"; ?>/<?php echo "$tittle";?>"><button type="button" class="btn btn-default btn-sm">View Application Details</button></a></td>
                                                    <td>
                                                        <a href="<?php echo base_url() ?>index.php/Validatedriver/validasiDriver/<?php echo "$d->nomor"; ?>/<?php echo "$tittle";?>"><button type="button" class="btn btn-primary btn-sm" onclick="return confirm('Are you sure to validate the registration of the driver ?')">Validation</button></a>
                                                        <a href="<?php echo base_url() ?>index.php/Validatedriver/tolakDriver/<?php echo "$d->nomor"; ?>/<?php echo "$tittle";?>">
                                    
                                    <button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to cancel the registration of the driver?')">
                                    <span class="fa fa-trash-o"></span></button></a>
                                                    </td>
                                                </tr>
<?php }
?>
