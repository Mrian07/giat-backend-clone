...
<html>
    <head>
        ...
        <title>GoTaxi App - Administrator</title>
			...
			<div class="top-nav-box">
				...
				<div class="user-top-profile">
					<div class="user-image">
						...
						<img alt="gotaxi" src="/asset/images/profile.jpg">
					</div>
					<div class="clear">
...
<div class="top-banner">
	...
	<div class="top-banner-subtitle">Welcome back, Admin, <i class="fa fa-map-marker"></i> Sydney, Australia</div>
</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Total Pengguna</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Total Ojek</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Transaksi bulanan</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Transaksi hari ini</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Ojek Online</div>
		...
		<div class="col-md-3 card-wrapper">
		    <div class="card">
				...
				<div class="clear">
						...
						<div class="card-subtitle">Ojek bekerja</div>
		...
		<div class="row">
		    ...
		    <div class="col-md-12">
                 <div class="content-header">
					...
					<div class="content-header-title">Transaksi Terakhir <?php echo date("M"); ?> <?php echo date("Y"); ?></div>
				</div>
                            <!-- TABLE: ORDER TERAKHIR -->
                                                        ...
                                                        <td>
                                                            ...
                                                            switch ($value->status_transaksi) {
                                                                case 'Search':
                                                                    ...
                                                                    break;
                                                                case 'Menawarkan':
                                                                    echo '<span class="label label-info">Tawaran</span>';
                                                                    break;
                                                                    
                                                                case 'Succeed':
                                                                    echo '<span class="label label-info">Sedang Proses</span>';
                                                                    break;
                                                                case 'Rejected':
                                                                ...
                                                                case 'Start':
                                                                    echo '<span class="label label-info">Mulai</span>';
                                                                    break;
                                                                default:
                                                                    break;
                                                            }
		...
		<div class="row">
			<div class="col-md-8">
				<div class="content-header">
					...
					<div class="content-header-title">Transaksi Rekap Bulanan</div>
				</div>
				<div class="content-box">
			...
			<div class="col-md-4">
				<div class="content-header">
					...
					<div class="content-header-title">Transaksi Detail Status</div>
				</div>
				<div class="content-box">
				 ...
				 <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <p class="text-center">
                                                Transaksi Details <?php echo date('F'); ?><br> 
...
<!-- footer-->
 ...
 <strong>Copyright &copy; 2017 - <?php echo date("Y"); ?> | <a href="http://gotaxi.biz">Go-TAXI</a>.</strong> All Rights Reserved.</strong>
</div>
<!--end footer-->
