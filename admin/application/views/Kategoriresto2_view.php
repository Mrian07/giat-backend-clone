...
<html>
    <head>
        ...
        <title>GoTaxi App - Edit Category Restaurant</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Edit Kategori Rumah Makan</div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <form action="<?php echo base_url(); ?>index.php/Kategoriresto/editKategori" method="POST" role="form" enctype="multipart/form-data">
                                            ...
                                            <img src="<?php echo base_url() . "/fotokategoriresto/" . $kategori[0]['foto']; ?>" class="img-responsive img-thumbnail" alt="Cinque Terre"><br>
