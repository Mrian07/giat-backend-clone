...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Cancel Order</div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($transaksi as $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        switch ($value->status_transaksi) {
                                                            ...
                                                            case 'Menawarkan':
                                                                ...
                                                                break;
                                                            case 'Succeed':
                                                                echo '<span class="label label-info">Succeed</span>';
                                                                break;
                                                            case 'Rejected':
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/Dashboard/cancelTransactionProcess/<?php echo $value->nomor; ?>/<?php echo $value->id_transaksi; ?>/<?php echo $value->id_driver; ?>/<?php echo $value->id_pelanggan; ?>" class="btn btn-sm btn-default btn-xs" onclick="return confirm('Are you sure you canceled the transaction ?')">Cancel Order</a>
                                                    </td>
                                                </tr> 
                                                <?php
                                            }
