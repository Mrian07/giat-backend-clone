...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title"> Dompet Topup Ojek</div>
...
//                                                        }
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url();?>index.php/drivertopup/validasiTopupForm/<?php echo $key->nomor;?>/<?php echo $key->id_user;?>"><button type="button" class="btn btn-primary btn-sm">Verification</button></a>
                                                        <a href="<?php echo base_url();?>index.php/drivertopup/batalTopup/<?php echo $key->nomor;?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to cancel the Top Up ?')"><span class="glyphicon glyphicon-remove"></span></button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
