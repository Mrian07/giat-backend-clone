...
<html>
    <head>
        ...
        <title>GoTaxi - Driver Information Details</title>
...
<a href="<?php echo base_url(); ?>index.php/listdriver/driverMotor"> Informasi Ojek Details </a> </div>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Informasi Ojek Details </div>
                        ...
                        <div class="col-md-12">
                            <div class="content-box">
                                <div class="box-header">
                                    <h3 class="box-title">Informasi Ojek Detail</h3>
