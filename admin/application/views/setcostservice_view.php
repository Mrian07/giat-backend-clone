...
<html>
    <head>
        ...
        <title>GOTAXI App - Service Cost</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title"> Set Basic Fare Go-Service</div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <label for="exampleInputEmail1">Minimum Cost ($)</label>
                                        ...
                                        <div class="form-group">
                                        <label for="exampleInputEmail1">Cost Description</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h3 class="text-center">Basic rate</h3>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <h3 class="text-center">Service Fee</h3>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Wash ($)</label>
