...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Set the cost price of services <?php echo "$tittle"; ?></div>
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="m1" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo "$m1"; ?>">
                                                            </div><br>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Minimum Charge ($)</label>
                                                                <input name="m2" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo "$m2"; ?>">
                                                            </div><br>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Minimum Charge ($)</label>
                                                                <input name="m3" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo "$m3"; ?>">
                                                            </div><br>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Minimum Charge ($)</label>
                                                                <input name="m4" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo "$m4"; ?>">
                                                            </div><br>
                                                        </div>
