...
<html>
    <head>
         ...
         <title>GoTaxi App - List <?php echo "$tittle"; ?></title>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($driver as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/Listdriver/detilMmassage/<?php echo $key->id; ?>"><button type="button" class="btn btn-default btn-xs">Detil</button></a>
