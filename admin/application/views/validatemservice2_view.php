...
<html>
    <head>
        ...
        <title>GO-TAXI Validate Driver</title>
	...
	<div class="top-nav-box">
		...
		<div class="logo-wrapper">
			<div class="logo-box">
				...
				<a href="/">
					<div class="logo-title">GOTAXI</div>
				</a>
			</div>
		</div>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Detail Pelamar</div>
                        ...
                        <div class="col-md-12">
                           <div class="content-box">
                                ...
                                <div class="box-header">
                                    <h3 class="box-title">Detail Pelamar</h3>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    <td><b>Pekerjaan </b></td>
                                                    <td><p class="text-left">: Go-Service</p></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-4">
                                            <!--style="width: 100%; height: 100%; border: 3px; border-color: white;"-->
                                            <!--<img src="../../../mangjek/asset/berkas_driver/foto_diri/<?php // echo $pendaftar[0]['foto_diri'];   ?>" class="img-responsive img-thumbnail" alt="Cinque Terre">-->
                                            <img src="<?php echo $hostberkas; ?>frontend/asset/berkas_mservice/foto_diri/<?php echo $pendaftar[0]['foto_diri']; ?>" class="img-responsive img-thumbnail" alt="Cinque Terre">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2"></div>
                                        <div class="col-md-4">
                                            <a class="btn btn-primary" href="<?php echo base_url() ?>index.php/Validatedriver/validasiMservice/<?php echo $pendaftar[0]['nomor']; ?>" role="button" onclick="return confirm('Are you sure to validate the registration ?')">Registration Validation</a>
                                            <a href="<?php echo base_url() ?>index.php/Validatedriver/tolakMservice/<?php echo $pendaftar[0]['nomor'];; ?>"><button type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to cancel the registration ?')"><span class="fa fa-trash-o"></span></button></a>
                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="content-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <!--style="width: 100%; height: 100%; border: 3px; border-color: white;"-->
                                    <img src="<?php echo $hostberkas; ?>frontend/asset/berkas_mservice/foto_ktp/<?php echo $pendaftar[0]['foto_ktp']; ?>" class="img-responsive img-thumbnail center-block" alt="">
