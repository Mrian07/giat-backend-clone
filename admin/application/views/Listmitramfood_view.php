...
<html>
    <head>
        ...
        <title>RESTAURANT - List Partners GoTaxi</title>
...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Daftar Rumah Makan </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($mitra as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#status<?php echo $key->idmitra; ?>">Ubah status</button>
                                                    </td>
                                                </tr>
