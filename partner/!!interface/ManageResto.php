                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <!--<h3 class="box-title">Mengatur informasi resto</h3>-->
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <!--FORM KIRI-->
                                            <div class="col-md-6">
                                                <h4 class="box-title text-center">informasi Data Resto</h4>
                                                <div class="box-body">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <!--option di database-->
                                                        <label for="sel1">Kategori Resto</label>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Kontak Telepon</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Deskripsi Resto</label>
                                            ...
                                            <!--FORM KANAN-->
                                            <div class="col-md-6">
                                                <h4 class="box-title text-center">informasi Data Akun</h4>
                                                <div class="box-body">
                                                    <div class="form-group">
