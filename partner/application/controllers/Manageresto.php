...
//        terima data dari form
    ...
    //    echo $_SERVER["DOCUMENT_ROOT"]."/asset/berkas_mmart_mfood/foto_restoran/$foto"; 
        
        
        if ($_FILES["userfile"]['name'] != NULL) {
            unlink($_SERVER["DOCUMENT_ROOT"]."/asset/berkas_mmart_mfood/foto_restoran/$foto");?>
            
            <script>alert(<?= $_SERVER["DOCUMENT_ROOT"]."/asset/berkas_mmart_mfood/foto_restoran/$foto"?>);
            </script>
            ...
            $config['upload_path'] = $_SERVER["DOCUMENT_ROOT"]."/asset/berkas_mmart_mfood/foto_restoran";
            ...
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Partner Data successfully updated</p> <br>";
            $this->index();
        } else {
            $model->setData1($namaresto, $kategoriresto, $alamat, $jambuka, $jamtutup, $kontaktelepon, $deskripsiresto);
            $this->pesan = "<p style=\"color:green\" class=\"text-center\">Partner Data successfully updated</p> <br>";
...
//        terima data dari form
        ...
        if ($passDB != $passlama) {
            $this->datakirim = array(
                ...
                "pesan" => "<p style=\"color:red\" class=\"text-center\">The old password you entered is incorrect</p> <br>",
                "id" => "$model->id",
                "email" => "$model->email",
            );
            ...
            $this->datakirim = array(
                "namaresto" => $this->namaresto,
                "pesan" => "<p style=\"color:blue\" class=\"text-center\">Partner Data successfully updated</p> <br>",
                "id" => "$model->id",
                "email" => "$model->email",
            );
