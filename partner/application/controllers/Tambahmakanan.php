...
//        $pathfiledelete = $_SERVER['DOCUMENT_ROOT'] . "/admin/fotokategoriresto/$namafoto";
        $pathfilesave = $_SERVER['DOCUMENT_ROOT'] . "/partner/fotomenumakanan/";
        ...
        $this->Makanan->tambahMenuMakanan($nama, $harga, $kategori, $deskripsi, $namafoto);
        $this->pesan = "<p style=\"color:green\" class=\"text-center\">Menu data successfully added</p> <br>";
        $this->index();
    }
