...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title">Food Category</div>
                            ...
                            <div class="content-box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <?php echo "$pesan"; ?>
                                            <h4 class="box-title text-center">Add Food Categories</h4>
                                            <div class="box-body">
                                                ...
                                                <form role="form" action="<?php echo base_url(); ?>index.php/Tambahmenumakanan/tambahMenuMakanan" method="POST">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button type="submit" class="btn btn-primary" style="margin-top: 25px">Add Now</button>
                                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url(); ?>index.php/Tambahmenumakanan/hapusMenuMakanan/<?php echo "$row->id"; ?>">
                                                                        <button type="button" class="btn btn-danger btn-sm center-block" onclick="return confirm('Are you sure to delete the food menu ?')">
