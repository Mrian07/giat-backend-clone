...
<div class="content with-top-banner">
	<div class="content-header no-mg-top">
		...
		<div class="content-header-title"> Edit Food Menu</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="content-box">
                                ...
                                <!-- /.box-header -->
                                <form role="form" action="<?php echo base_url(); ?>index.php/Listmakanan/editMakanan" method="POST" enctype="multipart/form-data">
                                    <?php echo $pesan; ?>
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nama" type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $dataedit[0]['nama_menu']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="harga" type="number" class="form-control" id="exampleInputEmail1" placeholder="" value="<?php echo $dataedit[0]['harga']; ?>">
                                                    </div>
                                                </div>
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Menu Description</label>
                                                        <textarea name="deskripsi" class="form-control" rows="3"><?php echo $dataedit[0]['deskripsi_menu']; ?></textarea>
                                                    </div>
                                                </div>

                                              <img style="width: 400px"src="<?php echo base_url() . "fotomenumakanan/" . $dataedit[0]['foto']; ?>" class="img-responsive img-thumbnail">
                                                <div class="box-body">
                                                    <div class="form-group"><br>
                                                          <label for="">Photo Food :</label>
                                                      <input type="hidden" name="id" value="<?php echo $dataedit[0]['id']; ?>" >
                                                <input type="hidden" name="fotolama" value="<?php echo $dataedit[0]['foto']; ?>" >
                                                <input name="userfile" type="file"  accept=".png, .jpg, .jpeg, .gif"></div>
                                                </div><br>
