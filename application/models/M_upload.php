...
class M_upload extends CI_Model{
    ...
    public function sendpassword_driver ($data) {
             ...
             $config = Array(
				...
				'smtp_port' => 587,
				'smtp_user' => 'AKIAQQJ2EY3SULFSYFAC',
				'smtp_pass' => 'BLHMOy56PQzU5KWtcPpwhu7K0xM6oTuqQywaGc0C3qbC',
				'mailtype' => 'html',
				'charset' => 'iso-8859-1'
        );
...
//        $this->email->set_newline("\r\n");
        ...
        $this->email->from('cs@gotaxi-app.com', 'Admin GoTaxi');
        $this->email->to($email);
        $this->email->subject('[IMPORTANT] GoTaxi Driver Reset Password Information');
        $this->email->message('
            <div style="background-color: #f9f9f9;" align="center"><br />
					  <table style="font-family: OpenSans,sans-serif; color: #666666;" border="0" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
					    <tbody>
					                    ...
					                    <tbody>
					                      <tr>
					                        <td><p style="color: #262626; font-size: 28px; margin-top:0px;"><strong>'.$nama.'</strong></p>
					                          <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;">Thank you for using GoTaxi Driver<br>
					      ...
					      <tr>
					        <td style="color: #262626; padding: 20px 0; font-size: 20px; border-top:5px solid #52bfd3;" colspan="2" align="center" bgcolor="#ffffff">Copyright @2018 GoTaxi App.</td>
					      </tr>
					    </tbody>
					  </table>
					</div>');
...
//        $this->email->set_newline("\r\n");
        ...
        $this->email->from('cs@gotaxi-app.com', 'Admin GoTaxi');
        $this->email->to($email);
        $this->email->subject('[IMPORTANT] GoTaxi App Reset Password Information');
        $this->email->message('
            <div style="background-color: #f9f9f9;" align="center"><br />
					  <table style="font-family: OpenSans,sans-serif; color: #666666;" border="0" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
					    <tbody>
					              ...
					              <tr>
					                <td valign="top"><table border="0" align="left" cellpadding="0" cellspacing="0" style="font-family:OpenSans,sans-serif; color: #666666; font-size: 10px; width:100%;">
					                    <tbody>
					                      <tr>
					                        <td><p style="color: #262626; font-size: 28px; margin-top:0px;"><strong>'.$nama.'</strong></p>
					                          <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;">Thank you for using GoTaxi App,<br>
					                            Your password is:<b> '.$passwordplain.'<b></p>
					                            <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;">After you login to account, please replace with your new password.</p>
					                          <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;margin-bottom:30px;">Best Regard,<br />
					                            GoTaxi App.</p></td>
