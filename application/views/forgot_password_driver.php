...
<head>
<meta charset="utf-8">
<title>GOTAXI- Forgot Paasword</title>
...
.form-header li{margin:0; line-height:60px; width:350px; text-align:center; background:#d50000; font-size:18px; float:left; transition:all 600ms ease}
...
.forgot-password span.icon{width:50px; transition:all 800ms; text-align:center; color:#d50000; height:40px; border-radius:0 3px 3px 0; background:#e8e8e8; height:40px; line-height:40px; display:inline-block; border:solid 1px #ccc; border-left:none; font-size:16px}
...
<li><i class="fa fa-lock"></i> FORGOT  PASSWORD  DRIVER</li>
...
<form id="resetPassword" name="resetPassword" method="post" action="<?php echo base_url();?>index.php/c_utama/ForgotPassword_Driver" onsubmit ='return validate()'>
