...
<head>
    ...
    <title>GoTaxi- On Demand Taxi All in one App Services</title>
            ...
            <div class="col-md-12">
                ...
                <ul class="menu">
                     ...
                     <li>
                        ...
                        class="call-to-action btn-primary">Admin panel </a>
                    </li>
                    
                    <li>
                        <a href="https://play.google.com/store/apps/details?id=com.gotaxiride.passenger" 
                        class="call-to-action btn-primary">USER Apk</a>
                    </li>
                    
                          
                    <li>
                        <a href="https://play.google.com/store/apps/details?id=com.gotaxiride.driver" 
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>index.php/c_utama/join" class="call-to-action btn-primary">
                            Join driver      </a>
                    </li>
            ...
            <div class="row">
                <div class="col-md-5 col-xs-12 image">
                    <div class="img-wrapper">
                        <img src="<?php echo base_url() ?>asset/images/booking_taxi.jpg" alt="What Is GOTAXI">
                    </div>
                </div>
                <div class="col-md-7 col-xs-12 text">
                    <h2 class="section-title">What Is <span class="inline">GoTaxi</span></h2>
                    <div class="line"></div>
                    
                    
                    <p style="text-align: justify;">
                        <span class="inline">GoTaxi</span> is an application on mobile devices (mobile phones / tablets) that facilitate the Amsterdam people to mobilize in the city area <b> Amsterdam </b> and Surroundings. GoTaxi is available for all Android device users. Equipped with several features that can be used by the Amsterdam community, among others, features Go-Moto (Motor), Go-Car (Taxi Online), GoFood (Food purchasing service), Go-Mart (Service purchase / shopping), GoMassage (Massage Services to your home), GoBox (Car Service Boxes for your business), GoSend (Service Delivery of goods / documents with motor) and GoService (Service such as washing AC). GoTaxi has been present in the city of Amsterdam to help you.
                    </p>
...
<section class="section-top-align Want_to_see radius_5">
    <div class="container  ">
        <div class="row text-center ">
            ...
            <div class="col-xs-12  ">
                 <h3 class="heading">Want to Join GoTaxi?</h3>
            ...
            <div class="col-xs-12  see_full_align wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s;">
                <a href="<?php echo base_url() ?>index.php/c_utama/join" class="btn btn-info btn btn-lg  Seo_section_testbtn">SignUp now</a>
            </div>
        </div>
    </div>
</section>  
 ...
 <section class="section section-services">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="heading">
                            We are ready to deliver whatever your needs.                        </h2>
                    </div>
                    <div class="box-services">
                            ...
                            <div class="card-services">
                                ...
                                <div class="content-services">
                                    ...
                                    <h3 class="sub-heading">
                                        Go-Taxi                                    </h3>
                                    <p>
                                       Transportation services by car to present comfort and style. Go to your destination safely                               </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-services">
                                ...
                                <div class="content-services">
                                    ...
                                    <h3 class="sub-heading">
                                        Go - Moto                                   </h3>
                                    <p>
                                        Motorized transport services to cope with congestion. Go to your destination quickly and safely.                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="card-services">
                                ...
                                <div class="content-services">
                                    ...
                                    <h3 class="sub-heading">
                                        Go - Massage                                    </h3>
                                    <p>
                                        24 hour call massage service, ready to be called home, office and wherever you are on the move.                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="card-services">
                                ...
                                <div class="content-services">
                                    ...
                                    <h3 class="sub-heading">
                                        Go - Food                                    </h3>
                                    <p>
                                        The world's largest food-service messaging service and working with 125,000 merchants                                   </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="card-services">
                                <div class="cover-services">
                                    <img src="<?php echo base_url() ?>asset/images/join_page/icon/mservice.png" alt="">
                                </div>
                                <div class="content-services">
                                    <div class="box-icon">
                                        <i class="services-icon icon-truck"></i>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="card-services">
                                <div class="cover-services">
                                    <img src="<?php echo base_url() ?>asset/images/join_page/icon/mstore.png" alt="">
                                </div>
                                <div class="content-services">
                                    <div class="box-icon">
                                        <i class="services-icon icon-truck"></i>
        ...
        <section class="section section-use">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="box-works">
                            <h2 class="heading">EASY OF USE OF GOTAXI</h2>
                            <div class="clearbox">
                            </div>
                            <ul class="list-work">
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>
                                       Once Driver finds you, easily contact them by phone or free chat. Rates will be adjusted according to the distance pick up and delivery                         </p>
                                </li>
                            </ul>
                        </div>
                    </div>
 ...
 <section class="section scene">
  ...
  <!-- <div class="direct-install install-user">
        <div class="content">
            ...
            <label>GoTaxi App</label>
            <a href="https://play.google.com/store/apps/details?id=com.gotaxiride.passenger" target="_blank" class="install"> Install</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <ul class="social-media">
                    ...
                    <li>
                        <a href="https://twitter.com/XXXXXX" target="_blank">
                            <i class="zmdi zmdi-twitter"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/XXXXX" target="_blank">
            ...
            <div class="col-md-3 offset-md-2">
                ...
                <ul>
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>index.php/c_utama/faq">F A Q </a>
                    </li> 
                
                    <li>
                        <a href="<?php echo base_url() ?>">Terms &amp; Condition</a>
                    </li> 
                    <li>
                        <a href="<?php echo base_url() ?>index.php/c_utama/privacy">Privacy Policy</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="box-button">
                    <!-- <a href="" class="google-play">
                        <img src="https://anterin.id/images/google-play.svg" alt="">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/c_utama/join" class="btn-primary-o">JOIN A DRIVER</a>
        ...
        <div class="col-md-12">
            <div class="copy">
                Copyright © 2018 GOTAXI. All rights reserved.
            </div>
        </div>
    </div>
</footer>
