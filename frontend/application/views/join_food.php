    ...
    <div class="container" style="padding-bottom: 10px;">
      <div class="row">
        ...
        <div class="layanan_isi-join-judul" style="font-family:'Yanone Kaffeesatz', 'sans-serif';">
         <p>Sign Up Immediately <font color='#FFCC00'>Bar, Cafe, or Your Restaurant</font> in GoTaxi</p>
        </div>        
        ...
        <div class="col-md-12">
          ...
          <div class="datadiri">
             ...
             <h1 style="font-weight:bold; font-size:35px; letter-spacing: 2px;">Informasi Umum</h1>
              ...
              <div class="col-md-6 form-group">
               <label>Alamat Rumah Makan</label>
             ...
             <label>Nama Pemilik</label>
              ...
              <div class="col-md-6 form-group">
                 <label>Alamat Email Pemilik</label>
          ...
          <div class="datakendaraan">
            ...
            <hr>
              ...
              <div class="col-md-12 form-group">
               ...
               <div class="col-md-6 form-group">
                 <label>Deskripsi Rumah Makan</label>
              ...
              <div class="col-md-6 form-group">
                <label>Foto Rumah Makan<br>(Format File JPG Max: 1MB)</label>
