...
<div class="col-md-3 col-xs-6" style="margin-top: 30px;">
 ...
 <div class="direct-install install-user">
        <div class="content">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.gamajek.driver" target="_blank" class="install"> Install</a>
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-4 col-sH-4 col-xs-12 brand_bottom">
                <h1 class="brand_name">
                    ...
                    <a href="index.php"><img src="<?php echo base_url() ?>asset/images/logo_header/heehjek_white.png" width="40%" style=""></a>
                </h1>
            ...
            <div class="col-lg-4 col-md-4 col-sH-4 col-xs-12">
                <h4 class="brand_follow_us" style="margin-left:0px; margin-bottom:15px; letter-spacing:3px; margin-top: 30px;">Layanan Customer</h4>
                <ul class="customer">
                    <li><a href="#">FAQ</a></li>
