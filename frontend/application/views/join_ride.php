...
<head>
  ...
  <title>REGISTRATION MOTO | GoTaxi</title>
...
<body>
  <?php
  $message = $this->session->userdata('nama_depan');
  print_r($message);
  ?>
  <header>
  ...
  <section id="layanan_isi-join-mride">
    <div class="container" style="padding-bottom: 10px;">
      <div class="row text-center">
        ...
        <div class="layanan_isi-join-judul2-mride">
          ...
          <h2 class="heading">Form Registrasi Ojek Motor</h2>
        </div>
    ...
    border-radius: 5px;">
          <p style="font-weight: bold;">
            <font color="#0D5C7D">Terms and Services</font>
          </p>
          <p>
            <font color="black">1.Ojek harus memiliki kendaraan sendiri.</font>
          </p>
          <p>
            <font color="black">2.Ojek wajib memiliki Hape Android Sendiri</font>
          </p>
          <p>
            <font color="black">3.Driver must have Driver license which is still active at least 6 months ahead</font>
          </p>>
        ...
        <form role="form" action="<?php echo base_url() ?>index.php/c_upload/upload" enctype="multipart/form-data" method="post">
          ...
          <div class="datadiri">
            ...
            <div class="col-md-6 form-group">
              ...
              <input style="margin: auto;" placeholder="Date of birth" type="date" class="tanggal form-control" name="tgl_lahir" />
            </div>
            ...
            <div class="col-md-6 form-group">
              <label>Foto Identitas KTP<br>(Format File JPG Max: 1MB)</label>
              <input type="file" placeholder="last_name" class="form-control" accept="image/*" name="foto_ktp">
            </div>


            <div class="col-md-6 form-group">
              <label>Foto STNK<br>(Format File JPG Max: 1MB)</label>
            ...
            <div class="col-md-6 form-group">
              <label>Foto Profil<br>(Format File JPG Max: 1MB)</label>
